...
void writeBoardData(Data boardDataReading) {
  ...
  //Firebase.setFloat(root + String(boardId) + "/temperature/" + currentDate + "/" + formattedTime, boardTemp); 
  //Firebase.setFloat(root + String(boardId) + "/humidity/" + currentDate + "/" + formattedTime, boardHumid); 
